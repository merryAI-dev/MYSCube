...
run_emulator_suite auth,firestore,storage "npx vitest run --config vitest.bff-integration.config.ts server/bff/storage-rules.integration.test.ts server/bff/project-registration-drafts.integration.test.ts server/bff/project-registration-attachment-repair.integration.test.ts"
