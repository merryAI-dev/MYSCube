...
const REVIEW_CHANGE_FIELDS: Array<{
  ...
  { key: 'proposalWordOriginalDocument', label: '제안서 파일', before: (project) => normalizeChangeValue(project.proposalWordOriginalDocument?.name), after: (draft) => normalizeChangeValue(draft.proposalWordOriginalDocument?.name) },
