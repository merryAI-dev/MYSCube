...
조회: 2026-09-21T06:32:54.131166+00:00 ~ 2026-09-21T06:33:01.445739+00:00 (UTC). Firestore 5개 collection 전체 페이지를 읽었으며 운영 쓰기는 하지 않았다.
...
| submissionResponses | 74 | 0 | 0 | 0 |
| paymentPlanInputFlags | 74 | 0 | 0 | 0 |
| department | 0 | 0 | 0 | 74 |
...
동일 운영 저장본에 존재하는 첨부 참조 216개 고유 경로를 Cloud Storage metadata GET으로 재조회했다. 215개 존재, 크기/MIME 불일치 0개. 404 한 개는 `projectRequestDrafts/321b0993-4e00-4386-9522-532c1337a571`에서만 참조한다. 원문 파일 내용의 무결성이나 최종 사용자 다운로드 권한 검증은 아니며 원본 삭제/수정은 하지 않았다. 근거 `/tmp/myscube-postdeploy-storage-audit.json` (권한 제한 로컬 보관).
