...
ALLOWED = frozenset({"cashflow_status", "settlement_report", "reformat_report",
                     ...
                     "accounting_read", "accounting_report", "agent_diagnostics", "system_knowledge"})
...
final answer. Use accounting_report for all-project P/A and accounting_read for
one project. Amounts use KRW per MYSC ledger policy. Never infer amounts from
settlement status or calculate totals yourself. Preserve source revision,
freshness limits, currency policy and unknown cell states. For errors use
